...
document.addEventListener('DOMContentLoaded', function() {
		...
		calendar.addEvent({'title':'범기생일', 'start':'2021-03-19'});
		calendar.addEvent({'title':'지명생일', 'start':'2022-04-29'});
		calendar.addEvent({'title':'누리생일', 'start':'2022-07-19'});
		calendar.addEvent({'title':'기현생일', 'start':'2022-01-29'});
		calendar.addEvent({'title':'민상종강', 'start':'2022-08-07'});
