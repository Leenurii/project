		...
		<table class="table table-bordered table-striped table-hove">
			...
			<c:forEach items="${list}" var = "list">
				<tr>
					...
					<td>
						<a href="/mealkit/admin/board/noticeDetail?n=${list.notice_bno }"><c:out value="${list.notice_title}" /></a>
					</td>
					<td>관리자</td>
		...
		<table class="table table-bordered table-striped table-hove">
			...
			<c:forEach items="${faqlist}" var = "faqlist">
				<tr>
					...
					<td>
						<a href="/mealkit/admin/board/faqUpdate?n=${faqlist.faq_bno }"><c:out value="${faqlist.faq_title}" /></a>
					</td>
