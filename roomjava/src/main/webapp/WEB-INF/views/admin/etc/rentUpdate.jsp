...
<%@ include file="../../include/m_header.jsp" %>
	...
	<div class="container">
		<form class="form-horizontal" name ="updateForm" role="form" method="post" action="/mealkit/admin/etc/rentUpdate?n=${update.rent_bno }">
...
$(document).ready(function(){
	...
	$(".cancel_btn").on("click", function(){
		...
		location.href = "/mealkit/admin/etc/etcList";
	})
})
</script>
