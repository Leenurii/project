		...
		<form role= "form" method="get">
			...
			<table class="table table-bordered table-striped table-hove">
				...
				<c:forEach items="${list}" var = "list">
					<tr>
						<td><a href="/mealkit/admin/etc/fncUpdate?n=${list.fnc_bno}"><c:out value="${list.fnc_bno}" /></a></td>
		...
		<form role= "form" method="get">
			...
			<table class="table table-bordered table-striped table-hove">
				...
				<c:forEach items="${list2}" var = "list">
					<tr>
						<td><a href="/mealkit/admin/etc/rentUpdate?n=${list.rent_bno }"><c:out value="${list.rent_bno}" /></a></td>
