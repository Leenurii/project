...
<div id="myContent">
	<div class="inner">
		<div class="left_bar">
			<ul class="myShopping">
				<li></li>
				<li><a href="/mealkit/member/myPage">예약 확인</a><span class="glyphicon glyphicon-chevron-right"></span></li>
				<li><a href="/mealkit/member/memberUpdate/${member.m_id}">회원 정보 수정</a><span class="glyphicon glyphicon-chevron-right"></span></li>
				<li><a href="/mealkit/member/memberDelete/${member.m_id}">회원 탈퇴</a><span class="glyphicon glyphicon-chevron-right"></span></li>
			</ul>
		</div>
<div class="m_content">
				...
				<table class="table table-hover table-bordered">
					...
					<tbody>
						<c:forEach var="bookList" items="${bookList}">		
							<tr>
								<td align=center><a href="/mealkit/member/myBookView?book_order=${bookList.book_order}">${bookList.book_order}</a></td>
...
$("#memberUpdateBtn").on("click", function() {
	location.href = "/mealkit/member/memberUpdate/" + $("#m_id").val();
});
</script>
</html>